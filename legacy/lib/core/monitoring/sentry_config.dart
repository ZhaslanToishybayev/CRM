...
///
/// TODO: Add sentry_flutter dependency to pubspec.yaml to re-enable
/*
...
*/
/// Temporary no-op implementation for Sentry
class SentryConfig {
  static const String dsn = '';

  static Future<void> initialize() async {
    print('⚠️ Sentry not configured (no-op implementation)');
  }

  static void captureException(Object exception, StackTrace stackTrace) {
    print('Exception captured (no-op): $exception');
  }

  static void captureMessage(String message) {
    print('Message captured (no-op): $message');
  }
}
