      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              GoRouter.of(context).go('/tasks/ai-assistant');
            },
          ...
          Card(
            ...
            child: Padding(
              ...
              child: userStatsAsync.when(
                data: (userStats) {
                  final stats = userStats ?? UserStatsModel.create(
                    id: currentUser?.id ?? '',
                        ...
                        trailing: Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () {
                                ref.read(tasksProvider(task.userId).notifier).deleteTask(task.effectiveId);
                              },
                            ),
                            IconButton(
                              icon: Icon(
                              ...
                              onPressed: () {
                                ref.read(tasksProvider(task.userId).notifier).completeTask(task.effectiveId);
                              },
                            ),
                          ],
                        ),
